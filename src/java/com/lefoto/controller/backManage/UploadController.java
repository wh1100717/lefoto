...
public class UploadController {
    ...
    public String upload(@RequestParam("Filedata") MultipartFile[] myfiles, HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        for (MultipartFile myfile : myfiles) {
            if (myfile.isEmpty()) {
                ...
                String destFileName = StringUtil.getRandomString(8) + type;
